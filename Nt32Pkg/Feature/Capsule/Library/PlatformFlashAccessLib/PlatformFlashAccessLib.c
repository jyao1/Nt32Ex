...
{
  return PerformFlashWrite(PlatformFirmwareTypeSystemFirmware, FlashAddress, FlashAddressTypeAbsoluteAddress, Buffer, Length);
}
...
{
  mInternalFdAddress = PcdGet64(PcdWinNtFdBaseAddressRuntime);
  return EFI_SUCCESS;
}