...
#define TPM_DEVICE_INTERFACE_TPM20_SIMULATOR  \
  { 0x6480adca, 0xa594, 0x41b4, { 0xb0, 0x6b, 0xdf, 0xff, 0xd7, 0x5d, 0x69, 0x45 } }
...
#define TPM_DEVICE_2_0_SIMULATOR  3
#define TPM_DEVICE_MIN            TPM_DEVICE_2_0_SIMULATOR
#define TPM_DEVICE_MAX            TPM_DEVICE_2_0_SIMULATOR
#define TPM_DEVICE_DEFAULT        TPM_DEVICE_2_0_SIMULATOR
...
#define TPM_INSTANCE_ID_LIST  { \
  ...
  {TPM_DEVICE_INTERFACE_TPM20_SIMULATOR, TPM_DEVICE_2_0_SIMULATOR},  \
}
